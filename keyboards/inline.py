...
class InlineKeyboards:
        ...
        keyboard = [
            ...
            [
                InlineKeyboardButton(
                    "🔧 Налаштування", callback_data="action:settings"
                ),
    ...
    def settings_menu(settings: dict) -> InlineKeyboardMarkup:
        keyboard = [
            [
                InlineKeyboardButton(
                    f"📄 Формат: {settings['fmt']}", callback_data="setting:format"
                ),
                InlineKeyboardButton(
                    f"📏 Розмір: {settings['size']}", callback_data="setting:size"
                ),
            ],
            [
                InlineKeyboardButton(
                    f"🎨 Колір: {settings['fg']}", callback_data="setting:fg_color"
                ),
                InlineKeyboardButton(
                    f"🎨 Фон: {settings['bg']}", callback_data="setting:bg_color"
                ),
            ],
            [
